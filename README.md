...
- Baixe o projeto desse repositório usando o comando `git clone https://github.com/bitAlison/pokemon_deck.git`
...
- Após o comando acima. no projeto raíz navegue para a pasta `coverage/teste-` e abra no navegador o arquivo: index.html
